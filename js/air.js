var element = document.querySelector(".bg-light-modified");
var exhibitionHome = document.getElementById("air-s");
...
window.addEventListener("scroll", function () {
  ...
  if (viewportBottom >= elementBottom) {
    element.style.background = "var(--localnav-background-stuck, rgba(238, 238, 238, 0.8))";
  } else {
    element.style.background = "var(--localnav-background-stuck, rgba(238, 238, 238, 1))";
  }
});
